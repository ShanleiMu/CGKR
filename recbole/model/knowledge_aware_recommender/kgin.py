...
class KGIN(KnowledgeRecommender):
    ...
    def __init__(self, config, dataset):
        ...
        print(type(self.interaction_feat[self.USER_ID]))
        self.interactions = zip(
            self.interaction_feat[self.USER_ID].to_numpy(), self.interaction_feat[self.ITEM_ID].to_numpy()
        )
    ...
    def calculate_loss(self, interaction):
        ...
        return mf_loss, cor_loss, reg_loss
